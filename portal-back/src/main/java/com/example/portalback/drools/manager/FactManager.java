package com.example.portalback.drools.manager;

import com.example.portalback.annotation.Fact;
import com.example.portalback.annotation.FactProperty;
import com.example.portalback.customer.entity.CustomerBaseInfo;
import com.example.portalback.drools.domain.PropertyBean;
...
public class FactManager {
	...
	static {
		...
		factList.add(CustomerBaseInfo.class);
		initFactDescription();
